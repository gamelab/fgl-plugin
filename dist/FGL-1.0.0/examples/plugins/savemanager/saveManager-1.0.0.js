Kiwi.Plugins.SaveGame = function() {

    this.name = 'SaveGame';
    this.version = '1.0.0';
    
    Kiwi.PluginManager.register(this);
...
* Example: You may want to save information locally so you would use the localStorage area on this saveManager but 
* if you wanted the information saved on a server then you would use a different 'plugin' that would save it onto a server. 
* 
* @class SaveManager
* @constructor
* @param game {Game}
...
Kiwi.Plugins.SaveGame.SaveManager.prototype.boot = function() {
    ...
    */
    ...
    /**
    * Refer's to the current saving 'method' that is being. More useful if you have multiple 
    * different ways of saving information and you want to switch between them. 
    * @property current
    * @public
    */
